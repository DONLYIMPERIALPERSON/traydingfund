...
export const env = {
  ...
  zeptoApiUrl: process.env.ZEPTO_API_URL ?? 'https://api.zeptomail.com/v1.1/email',
  zeptoToken: process.env.ZEPTO_TOKEN ?? '',
  zeptoFromEmail: process.env.ZEPTO_FROM_EMAIL ?? '',
  zeptoFromName: process.env.ZEPTO_FROM_NAME ?? '',
  zeptoReplyToEmail: process.env.ZEPTO_REPLY_TO_EMAIL ?? '',
  zeptoDashboardUrl: process.env.ZEPTO_DASHBOARD_URL ?? 'https://trader.machefunded.com',
