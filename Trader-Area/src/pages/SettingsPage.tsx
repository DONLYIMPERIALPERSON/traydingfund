...
import { changePin, getPinStatus, resetPin, sendPinOtp, setPin, fetchProfile, updateCertificateNameSetting } from '../mocks/auth'
      ...
      {activePinModal && (
        <div className="settings-pin-modal-overlay" onClick={handleClosePinModal}>
          <div className="settings-pin-modal" onClick={(e) => e.stopPropagation()}>
            ...
            {pinFormSuccess && (
              <div className="settings-pin-error settings-pin-success">{pinFormSuccess}</div>
            )}
