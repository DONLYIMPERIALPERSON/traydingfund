  ...
  if (loading) {
    return (
      <div className="support-page">
        <DesktopHeader />
        <DesktopSidebar />
        <div className="support-content-wrapper support-content-wrapper--center">
  ...
  if (error) {
    return (
      <div className="support-page">
        ...
        <DesktopSidebar />
        <div className="support-content-wrapper support-content-wrapper--center">
          <div className="support-state support-state--error">
            <div>Error: {error}</div>
            <button onClick={loadChats} className="support-retry">
              Try Again
            </button>
          </div>
        </div>
                  ...
                  {selectedChat.messages && selectedChat.messages.length > 0 ? (
                    ...
                    <div className="chat-empty">
                      <div>
                        ...
                        <p className="chat-empty-subtitle">Start the conversation below!</p>
                      </div>
                    </div>
                  )}
                </div>
